...
<div class="container-fluid backgreen-down">
  <div class="conatiner como-funciona">
    ...
    <div class="row como-funciona-detail">
      ...
      <div class="col-md-5">
        <div class="" data-aos="fade-left" data-aos-offset="300" data-aos-easing="ease-in-sine">
    ...
    <div class="row como-funciona-detail">
      <div class="col-md-5">
        <div class="" data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-out-sine">
          <p class="lead left"><img src="img/reloj-icon.svg" class="hidden-sm hidden-md hidden-lg"> 2. Escoge tu viaje y horario.</p>
        </div>
      </div>
    ...
    <div class="row como-funciona-detail">
      ...
      <div class="col-md-5">
        <div class="" data-aos="fade-left" data-aos-offset="300" data-aos-easing="ease-out-sine">
          <p class="lead right"><img src="img/asiento-icon.svg" class="hidden-sm hidden-md hidden-lg"> 3. Reserva y paga tu asiento.</p>
        </div>
      </div>
    </div>
    <div class="row como-funciona-detail">
        ...
        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox">
            <div class="item active text-center">
              ...
              <p class="lead">Saber que siempre tendrás tu lugar sentado.</p>
            </div>
            <div class="item text-center">
              <svg id="rutas" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="141px" height="141px" viewBox="0 0 141.7 141.7" style="enable-background:new 0 0 141.7 141.7;">
                ...
                <p class="lead">No perder tiempo en vueltas innecesarias.</p>
            </div>
            <div class="item text-center">
              <svg id="zzz" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="141px" height="141px" viewBox="0 0 141 141" style="enable-background:new 0 0 141 141;" >
                ...
                <p class="lead">Recuperar horas perdidas de sueño.</p>
            </div>
            <div class="item text-center">
              <svg id="cartera" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="141px" height="141px" viewBox="0 0 141 141" style="enable-background:new 0 0 141 141;" >
                ...
                <p class="lead">No tener que gastar toda tu quincena en traslados.</p>
            </div>
            <div class="item text-center">
              <svg id="laptop" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="141px" height="141px" viewBox="0 0 141 141" style="enable-background:new 0 0 141 141;" >
                ...
                <p class="lead">Mandar ese último correo en el viaje de regreso y disfrutar del acceso al WiFi gratis.</p>
            </div>
            <div class="item text-center">
              <svg id="chofer" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="141px" height="141px" viewBox="0 0 141 141" style="enable-background:new 0 0 141 141;">
                ...
                <p class="lead">Tener un conductor profesional y considerado.</p>
            </div>
          </div>
