      ...
      <form>
        <div class="modal-body">
            ...
            <div class="col-md-6 form-group">
              ...
              <input type="text" class="form-control" id="cellphone" placeholder="10 dígitos">
            </div>
            ...
            <div class="col-md-12 form-group">
              ...
              <input type="text" class="form-control" id="adress" placeholder="Calle, Nº, Colonia, Delegación, Ciudad, Estado">
            </div>
            ...
            <div class="col-md-6 form-group">
              ...
              <input type="text" class="form-control" id="adress" placeholder="AM / PM">
            </div>
