  ...
  <div class="row privacidad">
    ...
    <div>
      <ul class="indice">
          ...
          <div class="col-md-6">
            <li><a href="javascript:scroll('#diecinueve',800);">¿Cuánto cuesta viajar en Jetty?</a></li>
            <li><a href="javascript:scroll('#veinte',800);">¿De qué forma puedo comprar mi boleto?</a></li>
            <li><a href="javascript:scroll('#uno',800);">¿Con cuánto tiempo de anticipación puedo reservar mi viaje?</a></li>
            <li><a href="javascript:scroll('#veintiuno',800);">¿Puedo viajar en Jetty sin tener la app?</a></li>
            <li><a href="javascript:scroll('#veintidos',800);">¿Puedo llevar maletas grandes?</a></li>
            <li><a href="javascript:scroll('#veintitres',800);">¿Puedo subir mi bicicleta al Jetty?</a></li>
            <li><a href="javascript:scroll('#veinticuatro',800);">Olvidé algo en un Jetty, ¿qué tengo que hacer?</a></li>
            <li><a href="javascript:scroll('#veinticinco',800);">¿Puedo comer en mi Jetty?</a></li>
            <li><a href="javascript:scroll('#veintiseis',800);">¿Qué pasa si el sistema de cobro rechaza mi pago?</a></li>
            <li><a href="javascript:scroll('#veintisiete',800);">¿Qué hago si la app no funciona?</a></li>
            <li><a href="javascript:scroll('#veintiocho',800);">¿Puedo solicitar Jetty para un evento o viaje privado?</a></li>
            <li><a href="javascript:scroll('#veintinueve',800);">¿Puedo solicitar Jetty para un evento o viaje privado?</a></li>
            <li><a href="javascript:scroll('#treinta',800);">¿Puedo cancelar mi reservación?</a></li>
            <li><a href="javascript:scroll('#treintaiuno',800);">¿Mi reservación es transferible?</a></li>
            <li><a href="javascript:scroll('#trentaidos',800);">¿Qué hago si me equivoqué al reservar mi Jetty?</a></li>
            <li><a href="javascript:scroll('#trentaitres',800);">¿Cómo puedo pedir una factura?</a></li>
            <li><a href="javascript:scroll('#trentaicuatro',800);">¿Qué hago para trabajar en Jetty?</a></li>
            <li><a href="javascript:scroll('#trentaicinco',800);">¿Puedo comprar más de un boleto?</a></li>
          </div>
      </ul>
    </div>
    ...
    <div class="col-md-12"  style="margin-top: 40px">
      ...
      <h3 id="cincos">¿Cómo monitoreo mi viaje?</h3>
      ...
      <p>Sí. Como parte de nuestros estándares en Jetty, todas las unidades y usuarios a bordo se encuentran cubiertos por la póliza de seguros de cobertura amplia, así que puedes viajar con la tranquilidad de que, ante cualquier eventualidad, Jetty te cuida.</p>
      ...
      <p>Puedes comprar tu pase de abordar hasta 5 minutos antes del horario de partida, aunque es recomendable realizarlo con un poco más de anticipación para garantizar que tu asiento esté disponible.</p>
      ...
      <p>Por ahora no contamos con un sistema sencillo para mandar facturas por viaje pero podemos facturar el total de tus viajes del mes. La fecha de nuestro cierre  es el 25 de cada mes. Facturaríamos el total de todos tus viajes a partir del 25 del mes anterior hasta el 24 del mes en curso. Para hacerlo, envía un correo a <a href="mailto:cristina@jetty.mx" target="_blank">cristina@jetty.mx</a> con los datos fiscales y el correo al que quieres que lleguen.</p>
