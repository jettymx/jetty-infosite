...
<div class="container-fluid">
  <div class="container headerIndexTop">
    <div class="row marginBottom">
      ...
      <div class="col-md-8">
        <img src="{{site.baseurl}}/img/jetty-objetivos.png" class="imgResponsive" alt="Jetty, objetivos">
      </div>
    </div>
        ...
        <ul class="alianzas">
          ...
          <li>
            <a href="https://www.mitinclusiveinnovation.com/regions/latin-america/" target="_blank">
              <img src="{{site.baseurl}}/imgs-prensa/MIT-Income.jpg" alt="MIT Inclusive Innovation Challenge" style="width: 100px;">
            </a>
          </li>
          <li>
          ...
          <li>
            <img src="{{site.baseurl}}/imgs-prensa/30-promesas.png" alt="30 promesas de negocio" style="width: 140px">
          </li>
          <li>
            <img src="{{site.baseurl}}/imgs-prensa/NEGRO.png">
          </li>
          <li>
            <a href="http://sharedusemobilitycenter.org/2018-summit/" target="_blank">
          ...
          <li>
            <a href="https://developers.google.com/community/launchpad" target="_blank">
              <img src="{{site.baseurl}}/imgs-prensa/Google-Launchpad.png" alt="Google Launchpad" style="width: 250px;">
            </a>
          </li>
        </ul>
      </div>
    ...
    <div class="row marginBottom">
      ...
      <div class="col-md-12" style="margin-top: 50px">
        ...
        <ul class="alianzas">
          ...
          <li>
            <img src="{{site.baseurl}}/imgs-prensa/milenio.png">
          </li>
          <li>
            <img src="{{site.baseurl}}/imgs-prensa/expansion.png">
          </li>
          <li>
            <img src="{{site.baseurl}}/imgs-prensa/excelsior.png">
          </li>
          <li>
            <img src="{{site.baseurl}}/imgs-prensa/forbes.png">
          </li>
          <li>
            <img src="{{site.baseurl}}/imgs-prensa/animal-politico.png">
          </li>
          <li>
            <img src="{{site.baseurl}}/imgs-prensa/radiocentro.png">
          </li>
          <li>
            <img src="{{site.baseurl}}/imgs-prensa/televisa-news.png">
          </li>
          <li>
            <img src="{{site.baseurl}}/imgs-prensa/elfinanciero.png">
          </li>
          <li>
            <img src="{{site.baseurl}}/imgs-prensa/informador.png">
          </li>
          <li>
            <img src="{{site.baseurl}}/imgs-prensa/telediario.png">
          </li>
          <li>
            <img src="{{site.baseurl}}/imgs-prensa/elheraldo.png">
          </li>
          <li>
            <img src="{{site.baseurl}}/imgs-prensa/entrepreneur.png">
          </li>
          <li>
            <img src="{{site.baseurl}}/imgs-prensa/la-jornada.png">
          </li>
          <li>
            <img src="{{site.baseurl}}/imgs-prensa/chilango.png">
          </li>
          <li>
            <img src="{{site.baseurl}}/imgs-prensa/sopitas.png">
          </li>
          <li>
