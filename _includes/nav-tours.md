  ...
  <div class="container-fluid">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand brand-tours" href="{{ site.baseurl }}/">
          <img src="{{ site.baseurl }}/img/logo-jetty-slogan.svg">
        </a>
      </div>
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav navbar-right">
          ...
          <li><a href="{{site.baseurl}}/trabajo-transportista">Tu <img src="{{site.baseurl}}/img/icon-van.png" class="icon-van"> con Jetty</a></li>
